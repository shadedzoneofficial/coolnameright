importScripts("https://cdn.jsdelivr.net/gh/shadedzoneofficial/coolnameright@main/scram/scramjet.all.js");

const { ScramjetServiceWorker } = $scramjetLoadWorker();
const scramjet = new ScramjetServiceWorker();

// Broadcast errors back to all pages so we can display them
